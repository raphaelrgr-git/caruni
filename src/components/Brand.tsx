  ...
  return (
    <div className={`inline-flex items-center gap-2 ${className}`}>
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
        ...
        />
        <path
          d="M5 14.5h2l1.2-3.5h7.6l1.2 3.5h2v-1.4l-2.4-3.6a2 2 0 0 0-1.66-.9H8.86a2 2 0 0 0-1.66.9L5 13.1v1.4Z M7.5 16.5a1.2 1.2 0 1 1 0-2.4 1.2 1.2 0 0 1 0 2.4Z M16.5 16.5a1.2 1.2 0 1 1 0-2.4 1.2 1.2 0 0 1 0 2.4Z"
...
export function Avatar({
  ...
  return (
    <span
      className="inline-flex items-center justify-center overflow-hidden rounded-full font-semibold text-[11px] text-background select-none"
