...
function Selecao() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4 py-10 overflow-hidden relative">
      {/* Decoração de fundo */}
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              Publique sua rota, gerencie passageiros fixos e cubra os custos do seu deslocamento diário.
            </p>
            <ul className="mt-6 space-y-3">
              <li className="flex items-center gap-2 text-xs text-muted-foreground">
